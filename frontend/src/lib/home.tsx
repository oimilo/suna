...
export const siteConfig = {
  ...
  links: {
    email: 'support@milo.com',
    twitter: 'https://x.com/milo',
    // discord: 'https://discord.gg/kortixai',
    github: 'https://github.com/Milo-ai/Prophet',
  ...
  hero: {
    ...
    githubUrl: 'https://github.com/milo-ai/prophet',
    title: 'Milo – Build, manage and train your AI Workforce.',
    description:
      'Milo – open-source platform to build, manage and train your AI Workforce.',
    inputPlaceholder: 'Ask Milo to...',
  },
  cloudPricingItems: [
    {
      name: 'Basic',
  ...
  footerLinks: [
    {
      title: 'Milo',
      links: [
        { id: 1, title: 'About', url: 'https://milo.com' },
        { id: 3, title: 'Contact', url: 'mailto:hey@milo.com' },
        { id: 4, title: 'Careers', url: 'https://milo.com/careers' },
      ],
    },
    {
      title: 'Resources',
      links: [
        ...
        { id: 8, title: 'GitHub', url: 'https://github.com/Milo-ai/Prophet' },
      ],
    },
    {
      title: 'Legal',
      links: [
        {
          ...
          url: 'https://milo.com/legal?tab=privacy',
        },
        {
          id: 10,
          title: 'Terms of Service',
          url: 'https://milo.com/legal?tab=terms',
        },
        {
          id: 11,
          title: 'License Apache 2.0',
          url: 'https://github.com/Milo-ai/Prophet/blob/main/LICENSE',
        },
      ],
    },
  ],
