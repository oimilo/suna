...
export const siteConfig = {
  name: 'Prophet: Seu Super Trabalhador de IA',
  description: 'Feito para tarefas complexas, projetado para tudo. O assistente de IA definitivo que cuida de tudo—de solicitações simples a projetos mega-complexos.',
  cta: 'Começar Grátis',
  url: process.env.NEXT_PUBLIC_APP_URL || 'https://prophet.build',
  keywords: ['Prophet', 'AI Worker', 'Trabalhador IA', 'IA Generalista', 'Open Source AI', 'Agente Autônomo', 'Tarefas Complexas', 'Assistente IA'],
  links: {
  ...
  hero: {
    ...
    inputPlaceholder: 'Peça ao Prophet para...',
  },
  bentoSection: {
    title: 'Feito para o Futuro',
    description: 'Tudo que você precisa para automatizar seu trabalho',
    items: [
      {
        id: 1,
        title: 'Automação de Browser',
        description: 'Navegue, clique e interaja com qualquer site automaticamente',
        content: (
      ...
      },
      {
        ...
        description: 'Leia, escreva e organize arquivos perfeitamente',
        content: (
          <div className="flex items-center justify-center h-full">
            <FlickeringGrid className="size-full" />
          </div>
      ...
      },
      {
        ...
        description: 'Execute código em ambientes isolados e seguros',
        content: (
          <div className="flex items-center justify-center h-full">
            <FlickeringGrid className="size-full" />
          </div>
      ...
      },
      {
        id: 4,
        title: 'Busca na Web',
        description: 'Pesquise e extraia informações da web',
        content: (
          <div className="flex items-center justify-center h-full">
            <FlickeringGrid className="size-full" />
          </div>
  ...
  featureSection: {
    ...
    description: 'Ferramentas avançadas para automação inteligente',
    items: [],
  },
  growthSection: {
  ...
  ctaSection: {
    ...
    description: 'Comece a usar o Prophet gratuitamente e veja como a IA pode transformar seu trabalho.',
    button: {
      text: 'Começar Agora',
      href: '/dashboard',
    },
  ...
  faqSection: {
    ...
    description: 'Tudo que você precisa saber sobre o Prophet',
    faQitems: [
      {
        question: 'O que é o Prophet?',
        answer: 'Prophet é uma plataforma de IA que automatiza tarefas complexas, desde navegação web até execução de código.',
      },
      {
        question: 'Como funciona o período de teste?',
        answer: 'Você pode começar gratuitamente com créditos limitados. Upgrade para um plano pago para acesso completo.',
      },
      {
  ...
  quoteSection: {
    quote: '"O Prophet transformou completamente a forma como trabalhamos. Tarefas que levavam horas agora são feitas em minutos."',
    author: {
      name: 'Equipe Prophet',
  ...
  footerLinks: [
    {
      title: 'Prophet',
      links: [
        { id: 1, title: 'Sobre', url: 'https://prophet.build' },
        { id: 3, title: 'Contato', url: 'mailto:suporte@prophet.build' },
      ],
    },
    {
      title: 'Recursos',
      ...
      links: [
        {
          ...
          url: 'https://prophet.build/legal?tab=privacy',
        },
        {
          id: 10,
