...
document.querySelector('.btn-export').addEventListener('click', function() {
  ...
  },
  {
    ...
    messages: [
      {
        role: 'assistant',
        content: `Olá! Sou um Backend Developer e criei uma API REST completa em Node.js para você.
...
- **middleware.js**: Autenticação e validação
- **package.json**: Dependências do projeto
- **README.md**: Documentação completa

A API está pronta para rodar com \`npm install && npm start\`. Posso ajudar a adicionar mais endpoints, conectar um banco de dados ou implementar outras funcionalidades!`,
        timestamp: new Date(Date.now() - 10000).toISOString()
      }
    ],
    files: [
...
5. Adicionar Swagger documentation`
  ...
  },
  {
    ...
    messages: [
      {
        role: 'assistant',
        content: `Olá! Sou um Desenvolvedor Full Stack e criei um sistema de blog completo com editor Markdown para você.
...
Arquivos do projeto:
- **blog.html**: Interface do blog
- **editor.html**: Editor Markdown
- **blog.css**: Estilos e temas
- **markdown.js**: Parser e preview
- **articles.js**: Gerenciamento de posts

O blog está pronto para conteúdo! Abra index.html para ver. O que gostaria de ajustar primeiro?`,
        timestamp: new Date(Date.now() - 10000).toISOString()
      }
    ],
    files: [
...
Como você escolheu o perfil **"E-commerce Manager"**, desenvolvi uma loja virtual funcional e pronta para vender. Confira os detalhes:
...
export function getTemplateForProfile(profileType: string): Template | undefined {
  // Map profile types to template ids
