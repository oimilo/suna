      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-md text-muted-foreground max-w-2xl mx-auto">
            {isTrialExpired
              ? 'Your 7-day free trial has ended. Choose a plan to continue using Milo AI.'
              : 'A subscription is required to use Milo. Choose the plan that works best for you.'}
          </p>
        </div>
        <PricingSection
        ...
        <div className="text-center text-sm text-muted-foreground -mt-10">
          <p>
            ...
            <a href="mailto:support@milo.com" className="underline hover:text-primary">
              support@milo.com
            </a>
          </p>
        </div>
