...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Prophet',
    description: 'Replay this Agent conversation on Prophet',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Prophet';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Prophet';
