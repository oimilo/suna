...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://prophet.build/suna',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            logo: 'https://prophet.build/favicon.png',
            sameAs: [
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://prophet.build',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Suna is now Kortix',
                item: 'https://prophet.build/suna',
              },
            ],
          }),
        }}
