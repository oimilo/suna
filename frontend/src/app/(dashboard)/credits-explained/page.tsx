    ...
    <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
      ...
      <div className="space-y-3 mb-10">
        ...
        <p className="text-lg text-muted-foreground">
          Everything you need to know about how credits work on Prophet
        </p>
      </div>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed text-base">
            Credits serve as Prophet's universal currency for platform operations. Every action your AI agents perform—from analyzing data to generating code—consumes credits based on the task's complexity and the resources required.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            There are several ways to obtain credits in Prophet:
          </p>
        ...
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Prophet uses two types of credits to give you flexibility in how you manage your usage:
          </p>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Credit Priority:</strong> When you use Prophet, expiring credits are consumed first. Only after your expiring credits run out will non-expiring credits be used.
            </AlertDescription>
          </Alert>
        </div>
