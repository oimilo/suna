  ...
  return (
    <>
      <UnifiedUpgradeDialog
        ...
        icon={Crown}
        title="Unlock the Full Prophet Experience"
        description="Upgrade to unlock Prophet's full potential. Access our most powerful AI models and enhanced capabilities."
        theme="primary"
        size="sm"
