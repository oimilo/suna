...
export function KnowledgeBaseManager({
    ...
    React.useEffect(() => {
        setTreeData(prevTree => {
            const tree: TreeItem[] = folders.map(folder => {
                const existingFolder = prevTree.find(item => item.id === folder.folder_id);
    ...
    }, [enableAssignments, agentId, foldersLoading, folders, folderEntries, loadAssignments, fetchFolderEntries]);
