...
export const EventBasedTriggerDialog: React.FC<EventBasedTriggerDialogProps> = ({ open, onOpenChange, agentId, onTriggerCreated }) => {
  ...
  const variableSpecs = useMemo(() => {
    if (!selectedWorkflow) return [] as any[];
    ...
    return (child?.config?.playbook?.variables as any[]) || [];
  }, [selectedWorkflow]);
  ...
  }, [selectedWorkflow, executionType, variableSpecs, workflowInput]);
                            ...
                            <div className="space-y-4">
                              ...
                              {executionType === 'agent' ? (
                                ...
                                <div className="space-y-4">
                                  ...
                                  {selectedWorkflowId && variableSpecs && variableSpecs.length > 0 ? (
                                    <div className="space-y-3">
                                      {variableSpecs.map((v: any) => (
