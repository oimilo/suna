...
// localStorage keys
const SELECTED_MODE_KEY = 'selectedProphetMode';
...
export function useProphetModePersistence(): ProphetModesState & ProphetModesActions {
