...
import { AnnouncementsCenter } from '@/components/announcements/announcements-center';
...
const dashboardTourSteps: Step[] = [
  {
    ...
    content: `Type your questions or tasks here. ${BRANDING.name} can help with research, analysis, automation, and much more.`,
...
export function DashboardContent() {
  ...
  const isProphetAgent = selectedAgent?.metadata?.is_prophet_default || false;
  ...
  const handleTourCallback = useCallback((data: CallBackProps) => {
    ...
    const currentIndex = typeof data.index === 'number' ? data.index : 0;
