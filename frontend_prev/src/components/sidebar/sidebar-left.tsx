...
import { MiloProcessModal } from './milo-enterprise-modal';
            ...
            {state === 'collapsed' ? (
              <div className="pl-2 relative flex items-center justify-center w-fit group/logo">
                <Link href="/dashboard" onClick={() => isMobile && setOpenMobile(false)}>
                  <MiloLogo size={20} className="flex-shrink-0 opacity-100 group-hover/logo:opacity-0 transition-opacity" />
                </Link>
              ...
              <div className="pl-2 relative flex items-center justify-center w-fit">
                <Link href="/dashboard" onClick={() => isMobile && setOpenMobile(false)}>
                  <MiloLogo size={20} className="flex-shrink-0" />
                </Link>
              </div>
            )}
