...
export default function QuickStartPage() {
  ...
  const companyName = BRANDING.company;
  return (
    <>
      <DocsHeader
        ...
        <div className="mb-6">
          <CodeBlock 
            data={[{
              language: "bash",
              filename: "terminal",
              code: `git clone https://github.com/milo-ai/prophet.git
cd prophet`
            }]}
            defaultValue="bash"
          >
      ...
      <DocsBody className="mb-8">
        <h2 id="step-5-start">{`Step 5: Start ${companyName}`}</h2>
...
docker compose down`
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">You should see the {companyName} dashboard where you can start chatting with {productName} or create your own agents.</p>
