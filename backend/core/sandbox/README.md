...
2. Build a custom image:
   ...
   docker push milo/prophet:0.1.3.25
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `milo/prophet:___`)
...
3. Push the new version: `docker push milo/prophet:0.1.3`
