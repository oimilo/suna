...
-- This migration adds support for marking templates as Milo team templates
...
-- Add comment
COMMENT ON COLUMN agent_templates.is_kortix_team IS 'Indicates if this template is created by the Milo team (official templates)';
