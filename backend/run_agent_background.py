...
# [PROPHET CUSTOM] Limit for response list size to prevent memory bloat
...
# [PROPHET CUSTOM] TTL for Redis response lists (6 hours - reduced from 24h to save memory)
