...
# Prophet – Open Source Platform to Build, Manage and Train AI Agents

![Prophet Screenshot](frontend/public/banner.png)

**The complete platform for creating autonomous AI agents that work for you**

Prophet is a comprehensive open source platform that empowers you to build, manage, and train sophisticated AI agents for any use case. Create powerful agents that act autonomously on your behalf, from general-purpose assistants to specialized automation tools.

[![License](https://img.shields.io/badge/License-Apache--2.0-blue)](./license)
[![Discord Follow](https://dcbadge.limes.pink/api/server/milo?style=flat)](https://discord.gg/milo)
...
### 🤖 Includes Prophet – Flagship Generalist AI Worker
Meet Prophet, our showcase agent that demonstrates the full power of the Prophet platform. Through natural conversation, Prophet handles research, data analysis, browser automation, file management, and complex workflows – showing you what's possible when you build with Prophet.

### 🔧 Build Custom Prophet-Type Agents
Create your own specialized agents tailored to specific domains, workflows, or business needs. Whether you need agents for customer service, data processing, content creation, or industry-specific tasks, Prophet provides the infrastructure and tools to build, deploy, and scale them.
...
- [🌟 What Makes Prophet Special](#-what-makes-prophet-special)
...
### Prophet - Your Generalist AI Worker

Prophet demonstrates the full capabilities of the Prophet platform as a versatile AI worker that can:
...
The Prophet platform enables you to create agents tailored to specific needs:
...
Prophet consists of four main components that work together to provide a complete AI agent development platform:
...
Get your Prophet platform running in minutes with our automated setup wizard:
...
That's it! Your Prophet platform will be running with Prophet ready to assist you.
...
[Get Started](./docs/SELF-HOSTING.md) • [Join Discord](https://discord.gg/milo) • [Follow on Twitter](https://x.com/oimilo)
