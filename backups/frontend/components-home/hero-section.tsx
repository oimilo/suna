...
import { ProphetModesPanel } from '@/components/dashboard/prophet-modes-panel';
import { useProphetModePersistence } from '@/stores/prophet-modes-store';
...
export function HeroSection() {
    ...
    // Determine if selected agent is Prophet default
    // For unauthenticated users, assume Prophet is the default
    const selectedAgent = selectedAgentId
        ? agents.find(agent => agent.agent_id === selectedAgentId)
        : null;
    const isProphetAgent = !user || selectedAgent?.metadata?.is_prophet_default || false;
        ...
        <section id="hero" className="w-full relative overflow-hidden">
            ...
            <div className="relative flex flex-col items-center w-full px-4 sm:px-6 pb-8 sm:pb-10">
                ...
                <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
                    ...
                    {/* Modes Panel - Below chat input, visible for Prophet agent */}
                    {isProphetAgent && (
              ...
              >
                <X className="h-4 w-4 text-muted-foreground" />
                        ...
                        <DialogDescription className="text-muted-foreground">
                            Sign in or create an account to talk with Milo
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="mt-8 text-center text-[13px] text-muted-foreground leading-relaxed">
                        ...
                        <a href="https://www.milo.com/legal?tab=terms" target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-foreground underline underline-offset-2 transition-colors">
                            Terms of Service
                        </a>{' '}
                        and{' '}
                        <a href="https://www.milo.com/legal?tab=privacy" target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-foreground underline underline-offset-2 transition-colors">
                            Privacy Policy
                        </a>
                    </div>
                </DialogContent>
